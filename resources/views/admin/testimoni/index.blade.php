                    ...
                    <div class="col-md-12">
                        <form class="form-kategori">
                            <div class="mb-3 form-group">
                                <label for="" class="form-label">Nama Testimoni</label>
                                <input type="text" name="nama_testimoni" id="" class="form-control" placeholder="Nama Testimoni" required>
                            </div>
                            <div class="mb-3 form-group">
    ...
    <script>
        ...
        $(function() {
                ...
                success : function(data) {
                    ...
                    data.map(function (val, index) {
                        ...
                        <tr>
                            ...
                            <td>${val.deskripsi}</td>
                            <td><img src="/testimoni/${val.image}" width="150"></td>
                            <td>
            ...
            $(document).on('click', '.modal-ubah', function() {
                ...
                const id = $(this).data('id');
                $.get('/api/testimoni/' + id, function ({data}) {
