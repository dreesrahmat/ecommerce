    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Form Slider</h5>
                    ...
                    <div class="col-md-12">
                        <form class="form-kategori">
                            <div class="mb-3 form-group">
                                <label for="" class="form-label">Nama Slider</label>
                                <input type="text" name="nama_slider" id="" class="form-control" placeholder="Nama Kategori" required>
                            </div>
                            <div class="mb-3 form-group">
                ...
                success : function(data) {
                    ...
                    data.map(function (val, index) {
                        ...
                        <tr>
                            ...
                            <td>${val.deskripsi}</td>
                            <td><img src="/slider/${val.image}" width="150"></td>
                            <td>
