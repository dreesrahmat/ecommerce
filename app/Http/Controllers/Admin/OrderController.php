...
class OrderController extends Controller
{
    ...
    {
        return view('admin.order.baru');
    }

    public function pesanan_dikonfirmasi()
    {
        return view('admin.order.dikonfirmasi');
    }

    public function pesanan_dikemas()
    {
        return view('admin.order.dikemas');
    }

    public function pesanan_dikirim()
    {
        return view('admin.order.dikirim');
    }

    public function pesanan_diterima()
    {
        return view('admin.order.diterima');
    }
